...
var queryMain = `
query ($id: Int, $page: Int, $perPage: Int, $search: String, $season: MediaSeason, $seasonYear: Int, $format: MediaFormat, $format_not: MediaFormat, $format_in: [MediaFormat], $isAdult: Boolean, $status: MediaStatus) { # Define which variables will be used in the query (id)
    Page (page: $page, perPage: $perPage) {
      ...
      media (id: $id, type: ANIME, search: $search, season: $season, seasonYear: $seasonYear, format: $format, format_not: $format_not, format_in: $format_in, isAdult: $isAdult, status: $status) { # Insert our variables into the query arguments (id) (type: ANIME is hard-coded in the query)
            id
            idMal
            title {
                romaji
